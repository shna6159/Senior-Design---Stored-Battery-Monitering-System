...
class GUI(tk.Tk):
    ...
    def __init__(root):
        ...
        root.dur_choice.set(root.dur_options[1])
    ...
    def create_widgets(root):
        ...
        #ComPort Input
        root.Com = Entry(root, width = 20)
        root.Com.place(x = 250, y = 350)

        com = Label(root, text = 'Com Port (i.e. COM3)' )
        com.place(x = 250, y = 327)
        ...
        #Livefeed
        feed_background = Canvas(root , bg = 'grey' , width = 800,height = 1200)
    ...
    def comms(root):
        ...
        while FLAG == True:
            ...
            try:
                serialcomm = serial.Serial(comPort, 115200)
